...
export default function ResponsiveDrawer(props: Props) {
  ...
  return (
    ...
    <div style={{ display: 'flex' }} >
      ...
      <Toolbar />
        <Grid display='flex' sx={{ justifyContent:'end' }}>
          <Box sx={{ display: 'flex', border: 1, width: '250px', justifyContent: 'space-around', borderRadius: '10px', color: 'lightgrey', mr: '10px' }}>
            <Box>
              <Grid item sm={4}>
          ...
          <Box sx={{ display: 'flex', border: 1, width: '250px', justifyContent: 'space-around', borderRadius: '10px', color: 'lightgrey', ml: '10px' }}>
            <Box>
              <Grid item sm={4}>
                <Grid container direction="column" spacing={1}>
                  <Grid item>
